...
- Bump Cocoa SDK from v8.26.0 to v8.41.0 ([#20](https://github.com/nathanmkaya/sentry-kotlin-multiplatform/pull/20))
  - [changelog](https://github.com/getsentry/sentry-cocoa/blob/main/CHANGELOG.md#8410)
  - [diff](https://github.com/getsentry/sentry-cocoa/compare/8.26.0...8.41.0)
