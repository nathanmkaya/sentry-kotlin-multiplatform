...
- Bump Cocoa SDK from v8.26.0 to v8.39.0 ([#15](https://github.com/nathanmkaya/sentry-kotlin-multiplatform/pull/15))
  - [changelog](https://github.com/getsentry/sentry-cocoa/blob/main/CHANGELOG.md#8390)
  - [diff](https://github.com/getsentry/sentry-cocoa/compare/8.26.0...8.39.0)
