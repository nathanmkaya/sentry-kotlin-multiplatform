...
- Bump Cocoa SDK from v8.26.0 to v8.34.0 ([#7](https://github.com/nathanmkaya/sentry-kotlin-multiplatform/pull/7))
  - [changelog](https://github.com/getsentry/sentry-cocoa/blob/main/CHANGELOG.md#8340)
  - [diff](https://github.com/getsentry/sentry-cocoa/compare/8.26.0...8.34.0)
