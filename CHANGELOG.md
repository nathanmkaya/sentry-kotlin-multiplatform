...
- Bump Cocoa SDK from v8.26.0 to v8.40.0 ([#16](https://github.com/nathanmkaya/sentry-kotlin-multiplatform/pull/16))
  - [changelog](https://github.com/getsentry/sentry-cocoa/blob/main/CHANGELOG.md#8400)
  - [diff](https://github.com/getsentry/sentry-cocoa/compare/8.26.0...8.40.0)
