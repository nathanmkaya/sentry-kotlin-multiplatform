...
- Bump Cocoa SDK from v8.26.0 to v8.37.0 ([#11](https://github.com/nathanmkaya/sentry-kotlin-multiplatform/pull/11))
  - [changelog](https://github.com/getsentry/sentry-cocoa/blob/main/CHANGELOG.md#8370)
  - [diff](https://github.com/getsentry/sentry-cocoa/compare/8.26.0...8.37.0)
