...
- Bump Cocoa SDK from v8.26.0 to v8.42.1 ([#24](https://github.com/nathanmkaya/sentry-kotlin-multiplatform/pull/24))
  - [changelog](https://github.com/getsentry/sentry-cocoa/blob/main/CHANGELOG.md#8421)
  - [diff](https://github.com/getsentry/sentry-cocoa/compare/8.26.0...8.42.1)
